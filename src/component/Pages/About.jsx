...
const About = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            bio: "Prasad ensures every Saffron Stay delivers memorable experiences through innovative hospitality solutions.",
            image: CEO,
        },
        {
            name: "Arvind Sir",
            position: "Head of Design",
            bio: "Arvind brings spaces to life through thoughtful design that honors local culture while providing modern comfort.",
            image: HOD,
        },
        {
            name: "Kunal Sabale",
            position: "Operations Director",
            bio: "Kunal oversees the seamless functioning of all Saffron properties, maintaining our high standards of service.",
            image: EMP,
        },
    ];
