...
const AllCamps = () => {
    let { filteredCamps,theme, addBookmark, setAddBookmark } = useContext(staysContext);
    const [currentImageIndex, setCurrentImageIndex] = useState(0);
    const [ stayType , setStayType] = useState("camps");
    ...
    const currentTents = filteredCamps.slice(indexOfFirstTents, indexOfLastTents);
    ...
    return (
        <Box>
            ...
            sx={{ display: "flex", justifyContent: "center" ,bgcolor:"white" }}>
                <Pagination
                    count={Math.ceil(filteredCamps.length / TentsPerPage)}
                    page={page}
