        ...
        <TabContext value={value}>
            ...
            <TabPanel value="6">
                <Box sx={{ width: "100%", display: "flex", flexDirection: { xs: "column", sm: "row", lg: "row" }, justifyContent: "space-between", gap: 1 }}>
                    <Paper sx={{ p: 1, width: { xs: "100%", lg: "50%" }, height: { xs: "40vh", sm: "45vh", lg: "100vh" } }}>
                        {(val?.propertyLayout?.roomOptions || val.propertyLayout.RoomOptions)?.map((val) => (
                            <Box key={val.i} >
            ...
            <TabPanel value='9' sx={{ display: "flex", justifyContent: "center" }}>
                <Paper sx={{ width: { xs: "100%", lg: "30%" }, display: "flex", flexDirection: "column", p: 1, alignItems: "center", justifyContent: "center" }}>
                    <Box >
