...
const AllApartments = () => {
    let { filteredApartments,theme, addBookmark, setAddBookmark } = useContext(staysContext);
    ...
    const currentTents = filteredApartments.slice(indexOfFirstTents, indexOfLastTents);
    ...
    return (
        <Box>
            ...
            sx={{ display: "flex", justifyContent: "center",bgcolor:"white"  }}>
                <Pagination
                    count={Math.ceil(filteredApartments.length / TentsPerPage)}
                    page={page}
