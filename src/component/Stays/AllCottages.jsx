...
const AllCottages = () => {
    let { filteredCottages, theme, addBookmark, setAddBookmark } = useContext(staysContext);
    const [currentImageIndex, setCurrentImageIndex] = useState(0);
    const [stayType, setStayType] = useState("cottages");
    ...
    const currentTents = filteredCottages.slice(indexOfFirstTents, indexOfLastTents);
    ...
    return (
        <Box>
            ...
            <Box
                ...
                <Pagination
                    count={Math.ceil(filteredCottages.length / TentsPerPage)}
                    page={page}
